...
export default function Profile(props) {
    const style = () => {
        if (props.mode === "light") {
            return [{ border: "2px solid black" }, { color: "black" }, { backgroundColor: "#f0f5f5" }]
        } else {
            return [{ border: "2px solid white" }, { color: "white" }, { backgroundColor: "#1c1e21" }]
        }
    }
    return (
        <>
            <div className="container-fluid my-container" style={style()[2]}>
                <div className="description shadow-lg">
            ...
            <div className="container-fluid d-flex justify-content-center" style={style()[2]}>
                <div className="skill-container shadow-lg">
                    ...
                    <h5><strong>Embedded<br/>System</strong></h5>
                        ...
                        <button className='btn btn-primary btn-lg'>Project</button>
                    </div>
                </div>
            </div>
        </>
